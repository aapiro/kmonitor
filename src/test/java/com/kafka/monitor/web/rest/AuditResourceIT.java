...
import com.kafka.monitor.config.audit.AuditEventConverter;
import com.kafka.monitor.domain.PersistentAuditEvent;
import com.kafka.monitor.repository.PersistenceAuditEventRepository;
import com.kafka.monitor.security.AuthoritiesConstants;

import com.kafka.monitor.service.AuditEventService;
