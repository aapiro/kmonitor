...
@RestController
@RequestMapping("/api/kafka-monitor-kafka")
public class KafkaMonitorKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KafkaMonitorKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KafkaMonitorKafkaResource(KafkaProperties kafkaProperties) {
